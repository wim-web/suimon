...
import { deriveKinds, findWorkflow, incoming, isEndpoint, outgoing } from '../src/lib/program';
...
it('keeps parallel placements apart, labels branch arms and honours given positions', () => {
  const merge = program('merge'), w = merge.workflows[0]!;
