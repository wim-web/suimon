...
theorem Reachable.settled_invocations_ended {p : Program} {s : State} (h : Reachable p s) :
...
theorem Reachable.settled_stream {p : Program} {s : State} (h : Reachable p s) :
...
theorem Reachable.waitStream_result {p : Program} {s : State} (h : Reachable p s) :
...
theorem Reachable.call_returns_after_run {p : Program} {s : State} (h : Reachable p s) :
...
theorem Reachable.complete_run_settled {p : Program} {s : State} (h : Reachable p s) :
